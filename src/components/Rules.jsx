...
const rules = [
{ icon: "📵", title: "Unplugged Ceremony", desc: "Feel free to capture memories from your seat. To help our photo and video team document every special moment, please keep the aisles and reception walkways clear and avoid blocking their line of sight 🤍" },
...
*/
{ icon: "👶", title: "Adults Only", desc: "As much as we adore the little ones, this day is strictly for the grown-ups. Thank you for understanding!" },
...
{ icon: "⛪", title: "Will the ceremony and reception be indoors or outdoors?", desc: "The ceremony will be held inside the church — we recommend bringing a handheld or portable fan for comfort. The reception will be fully indoors." },
...
<Typography as="p" variant="sectionTitle" className="text-gold mb-5">Things to Know</Typography>
